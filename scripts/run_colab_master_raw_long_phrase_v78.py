"""Goal-eligible raw long-phrase singing synthesis on the 2048-song corpus.
...
from scripts.run_colab_master_vocal_mix_clarity_v67 import (
    mix_clarity_candidate,
)
from scripts.run_colab_master_waveform_path_v65 import (
    extract_source_unit,
)
from scripts.run_colab_master_waveform_unit_v64 import (
    SAMPLE_RATE,
    Unit,
    _similarity,
    duration_statistics,
