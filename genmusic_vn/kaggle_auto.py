        ...
        json.dumps(
            {
                ...
                "id": dataset_ref,
                "licenses": [{"name": "other"}],
                "subtitle": "Raw Vietnamese text request and pipeline source for Kaggle custom music generation.",
...
def submit_kaggle_job(
    ...
    *,
    ...
    if state.get("job_kind") == "tts_retry":
        ...
        state["messages"].append("Kaggle custom composer kernel submitted.")
    _write_state(state)
