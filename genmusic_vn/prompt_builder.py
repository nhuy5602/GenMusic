...
def build_music_prompt(
    ...
    rhyme_hint = f"; lyric rhyme scheme: {lyrics.rhyme_scheme}" if lyrics.rhyme_scheme else ""
    ...
    prompt = (
        ...
        f"song form: {song_form}{rhyme_hint}; "
        ...
        "compose a catchy singer-ready melody for the Vietnamese lyric sheet; "
        "make the chorus memorable with one short anchor phrase repeated in lines 1 and 3; "
        "use selective vowel assonance and varied line endings instead of forcing every adjacent pair to rhyme; "
        "leave comfortable syllable spacing so the vocal fills the planned arrangement without rushing; "
