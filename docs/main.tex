...
thất bại là bằng chứng đây không đơn thuần là thiếu warmup/LR quá cao, mà nhiều khả năng là một
khác biệt sâu hơn giữa dữ liệu raw-audio pristine (đa dạng hơn) và dữ liệu mel-detour mà công
thức gốc được validate — cần điều tra kỹ hơn, ngoài phạm vi thời gian còn lại của report này.
