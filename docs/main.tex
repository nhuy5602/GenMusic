...
\begin{enumerate}[label=\arabic*)]
    \item Huấn luyện tiếp nhánh latent-space (\S\ref{sec:latent_space}) tới khi
      early stopping tự kích hoạt thật, thay vì bị cắt ngang do hết quota Kaggle,
      rồi điền lại số liệu ở bảng \ref{tab:mel_vs_latent} và \S\ref{sec:exp4_mel_vs_latent}.
