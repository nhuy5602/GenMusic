...
**Giả thuyết alpha_feature bị bác bỏ**: lần thử thứ 6 (`ddvnam05/genmusic-distill-1784203849`,
`alpha_feature=0.8`, giảm trọng số teacher-matching) cho std=1.27 — **không cao hơn** alpha=0.5
